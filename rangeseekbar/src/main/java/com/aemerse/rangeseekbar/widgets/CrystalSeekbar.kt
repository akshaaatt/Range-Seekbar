...
open class CrystalSeekbar @JvmOverloads constructor(
    ...
    private var thumbWidthHere = 0f
    private var thumbHeightHere = 0f
    ...
    fun getDiameter(typedArray: TypedArray): Float {
        return typedArray.getDimensionPixelSize(R.styleable.CrystalSeekbar_thumb_diameter,
    ...
    fun apply() {
        ...
        barHeight = thumbHeightHere * 0.5f * 0.3f
    ...
    protected fun getBarHighlightColorMode(typedArray: TypedArray): Int {
        return typedArray.getInt(R.styleable.CrystalSeekbar_bar_highlight_color_mode,
            ColorMode.SOLID)
    }
    ...
    protected fun getBarHighlightGradientStart(typedArray: TypedArray): Int {
        return typedArray.getColor(R.styleable.CrystalSeekbar_bar_highlight_gradient_start,
            Color.DKGRAY)
    }

    protected fun getBarHighlightGradientEnd(typedArray: TypedArray): Int {
        return typedArray.getColor(R.styleable.CrystalSeekbar_bar_highlight_gradient_end,
            Color.BLACK)
    }
    ...
    protected fun setupLeftThumb(canvas: Canvas, paint: Paint?, rect: RectF?) {
        ...
        thumbRect!!.top = 0f
        thumbRect!!.bottom = thumbHeightHere
        if (thumb != null) {
